...
with st.sidebar:
    ...
    garden_name = st.text_input("Garden Name", value="My Garden")
...
body{{font-family:'DM Sans',sans-serif;background:var(--parch);color:var(--tx);}}
...
if st.session_state.results:
    ...
    with tab_planner:
        ...
        components.html(planner_html, height=780, scrolling=True)
